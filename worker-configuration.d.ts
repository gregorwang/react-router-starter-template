/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b023e29668c8c5aebcb0b5a4944f94b4)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		XAI_API_KEY: string;
		POE_API_KEY: string;
		CHAT_RATE_LIMITER_DO: DurableObjectNamespace<import("./workers/app").ChatRateLimiter>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "DEEPSEEK_API_KEY" | "XAI_API_KEY" | "POE_API_KEY">> {}
}
